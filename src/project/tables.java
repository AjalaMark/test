...
public class tables {
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            st.executeUpdate("create table customer(id int,name varchar(200),phoneNumber varchar(20),nationality varchar(200),gender varchar(50),email varchar(200),idProof varchar(200),address varchar(400),checkIn varchar(50),roomNumber varchar(10),bed varchar(200),roomType varchar(200),pricePerDay int(10),numberofDaysStay int(10),totalAmount varchar(200),checkout varchar(50))");
